                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.leads.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('contact_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_name" id="contact_name" value="{{ old('contact_name', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('contact_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="contact_number" id="contact_number" value="{{ old('contact_number') }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('contact_mail') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_mail" id="contact_mail" value="{{ old('contact_mail') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('account_manager') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="account_manager" id="account_manager" value="{{ old('account_manager', '') }}" required>
